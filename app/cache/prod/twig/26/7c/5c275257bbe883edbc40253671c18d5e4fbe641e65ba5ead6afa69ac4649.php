...
<script>
        ...
        echo "    var dataObject =
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["remboursements"]) ? $context["remboursements"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["remboursement"]) {
            // line 15
            echo "                ";
            if ($this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "created")) {
                // line 16
                echo "                {
                    ";
                // line 17
                ...
                // line 18
                echo "                    \"startDate\":\"";
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "created"), "Y,m,d"), "html", null, true);
                echo "\",
                    \"endDate\":\"";
                // line 19
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "created"), "Y,m,d"), "html", null, true);
                echo "\",
                    \"headline\":\"";
                // line 20
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "activite"), "nom"), "html", null, true);
                echo "<br/>";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "membre"), "nom"), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "membre"), "prenom"), "html", null, true);
                echo "\",
                    \"text\":\"<p><b>Montant activité :</b> ";
                // line 21
                echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "prix"), 2), "html", null, true);
                echo " €<br/><b>Montant participation :</b> ";
                echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "montantParticipation"), 2), "html", null, true);
                echo " € ";
                if ($this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "valide")) {
...
\t\t\t\t\t\t\t\t";
                ...
                echo "                                \"</tr>\" +
                                ...
                                \"<td>";
                // line 39
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["remboursement"]) ? $context["remboursement"] : null), "membre"), "famille"), "agence"), "nom"), "html", null, true);
                echo "</td>\" +
                                \"</tr>\" +
                                \"<tr>\" +
