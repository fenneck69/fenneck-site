...
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"tarifUgc\" value=\"";
        // line 198
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["cinemaUGC"]) ? $context["cinemaUGC"] : null), "prixPlein"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"tarifCGR\" value=\"";
        // line 199
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["cinemaCGR"]) ? $context["cinemaCGR"] : null), "prixPlein"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"tarifPathe\" value=\"";
        // line 200
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["cinemaPATHE"]) ? $context["cinemaPATHE"] : null), "prixPlein"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"reducUgc\" value=\"";
        // line 201
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["cinemaUGC"]) ? $context["cinemaUGC"] : null), "prixReduit"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"reducCGR\" value=\"";
        // line 202
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["cinemaCGR"]) ? $context["cinemaCGR"] : null), "prixReduit"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"reducPathe\" value=\"";
        // line 203
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["cinemaPATHE"]) ? $context["cinemaPATHE"] : null), "prixReduit"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"tarifMulti\" value=\"";
        // line 205
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["chequeLire"]) ? $context["chequeLire"] : null), "prixPlein"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"reducMulti\" value=\"";
        // line 206
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["chequeLire"]) ? $context["chequeLire"] : null), "prixReduit"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"pourcentSport\" value=\"";
        // line 208
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["aboSport"]) ? $context["aboSport"] : null), "taux"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"limitSport\" value=\"";
        // line 209
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["aboSport"]) ? $context["aboSport"] : null), "plafond"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"pourcentSpectacle\" value=\"";
        // line 211
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["aboSpectacle"]) ? $context["aboSpectacle"] : null), "taux"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"limitSpectacle\" value=\"";
        // line 212
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["aboSpectacle"]) ? $context["aboSpectacle"] : null), "plafond"), 2), "html", null, true);
        echo "\" />
\t\t\t\t\t\t\t\t
                                    </div>
                                </div>
