 ...
 */
class File extends \Gestion\CoreBundle\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'originalName', 'size', 'metadata', 'copywrite', 'author', 'title', 'caption', 'description', 'hash', 'version', 'currentVersion', 'enabled', 'scheduledForDeletion');
        }
