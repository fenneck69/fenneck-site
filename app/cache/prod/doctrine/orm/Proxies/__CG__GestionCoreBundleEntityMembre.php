 ...
 */
class Membre extends \Gestion\CoreBundle\Entity\Membre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'id', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'famille', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'nom', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'prenom', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'email', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'dateNaissance', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'type', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Membre' . "\0" . 'remboursements');
        }
    ...
    public function addRemboursement(\Gestion\CoreBundle\Entity\Remboursement $remboursements)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRemboursement', array($remboursements));

        return parent::addRemboursement($remboursements);
    }
    ...
    public function removeRemboursement(\Gestion\CoreBundle\Entity\Remboursement $remboursements)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRemboursement', array($remboursements));

        return parent::removeRemboursement($remboursements);
    }
    ...
    public function getRemboursements()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRemboursements', array());
