 ...
 */
class Gallerie extends \Gestion\CoreBundle\Entity\Gallerie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Gallerie' . "\0" . 'items', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Gallerie' . "\0" . 'id', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Gallerie' . "\0" . 'titre', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Gallerie' . "\0" . 'isAffiche', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Gallerie' . "\0" . 'created', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\Gallerie' . "\0" . 'updated');
        }
