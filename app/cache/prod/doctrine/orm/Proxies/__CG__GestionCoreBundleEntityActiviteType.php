 ...
 */
class ActiviteType extends \Gestion\CoreBundle\Entity\ActiviteType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\ActiviteType' . "\0" . 'id', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\ActiviteType' . "\0" . 'nom', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\ActiviteType' . "\0" . 'code', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\ActiviteType' . "\0" . 'activites');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActiviteType $proxy) {
