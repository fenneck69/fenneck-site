 ...
 */
class MembreType extends \Gestion\CoreBundle\Entity\MembreType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\MembreType' . "\0" . 'id', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\MembreType' . "\0" . 'nom', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\MembreType' . "\0" . 'code', '' . "\0" . 'Gestion\\CoreBundle\\Entity\\MembreType' . "\0" . 'activites');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MembreType $proxy) {
