...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gestion_core.admin.gallerie' => 'getGestionCore_Admin_GallerieService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/fenneck-site/app/cache/prod/annotations', false);
    }

    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/fenneck-site/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventSubscriber($this->get('thrace_media.doctrine.orm.event_subscriber.file_upload'));
        $b->addEventSubscriber($a);
        $b->addEventSubscriber($this->get('thrace_media.doctrine.orm.event_subscriber.image_upload'));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'fenneck-web', 'user' => 'fenneck-web', 'password' => 'karlkruser', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setProxyDir('C:/wamp/www/fenneck-site/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9c1fd970edc77052b10a50ebf5104a6413554afb0afc7ac0ad284fb1b5dde1b1');
        return $instance;
    }
    ...
    protected function getGestionCore_Admin_GallerieService()
    {
        $instance = new \Gestion\CoreBundle\Admin\GallerieAdmin('gestion_core.admin.gallerie', 'Gestion\\CoreBundle\\Entity\\Gallerie', 'GestionCoreBundle:GallerieAdmin');
        $instance->setFormTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:form_admin_fields.html.twig'));
        $instance->setFilterTheme(array(0 => 'SonataDoctrineORMAdminBundle:Form:filter_admin_fields.html.twig'));
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/fenneck-site/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/fenneck-site/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/fenneck-site/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group', 2 => 'sonata.agence.admin', 3 => 'gestion_core.admin.activite', 4 => 'gestion_core.admin.activite_type', 5 => 'gestion_core.admin.famille', 6 => 'gestion_core.admin.membre', 7 => 'gestion_core.admin.gallerie', 8 => 'gestion_core.admin.membre_type', 9 => 'gestion_core.admin.quotient', 10 => 'gestion_core.admin.remboursement'));
        $instance->setAdminGroups(array('sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group')), 'Reglages' => array('label' => 'Reglages', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<span class=\'fa fa-gears\'></span>', 'roles' => array(), 'items' => array(0 => 'sonata.agence.admin', 1 => 'gestion_core.admin.activite', 2 => 'gestion_core.admin.activite_type', 3 => 'gestion_core.admin.membre_type', 4 => 'gestion_core.admin.quotient')), 'Remboursements' => array('label' => 'Remboursements', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<span class=\'fa fa-briefcase\'></span>', 'roles' => array(), 'items' => array(0 => 'gestion_core.admin.famille', 1 => 'gestion_core.admin.membre', 2 => 'gestion_core.admin.gallerie', 3 => 'gestion_core.admin.remboursement'))));
        $instance->setAdminClasses(array('Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group'), 'Gestion\\CoreBundle\\Entity\\Agence' => array(0 => 'sonata.agence.admin'), 'Gestion\\CoreBundle\\Entity\\Activite' => array(0 => 'gestion_core.admin.activite'), 'Gestion\\CoreBundle\\Entity\\ActiviteType' => array(0 => 'gestion_core.admin.activite_type'), 'Gestion\\CoreBundle\\Entity\\Famille' => array(0 => 'gestion_core.admin.famille'), 'Gestion\\CoreBundle\\Entity\\Membre' => array(0 => 'gestion_core.admin.membre'), 'Gestion\\CoreBundle\\Entity\\Gallerie' => array(0 => 'gestion_core.admin.gallerie'), 'Gestion\\CoreBundle\\Entity\\MembreType' => array(0 => 'gestion_core.admin.membre_type'), 'Gestion\\CoreBundle\\Entity\\Quotient' => array(0 => 'gestion_core.admin.quotient'), 'Gestion\\CoreBundle\\Entity\\Remboursement' => array(0 => 'gestion_core.admin.remboursement')));
        return $instance;
    }

    protected function getSonata_Admin_Route_CacheService()
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('C:/wamp/www/fenneck-site/app/cache/prod/sonata/admin', false);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/fenneck-site/app/cache/prod/translations', 'debug' => false));
        ...
        $instance->addResource('xliff', 'C:/wamp/www/fenneck-site/app/Resources/SonataAdminBundle/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        ...
        $instance->addResource('xliff', 'C:/wamp/www/fenneck-site/app/Resources/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:/wamp/www/fenneck-site/app/Resources/translations\\SonataUserBundle.fr.xliff', 'fr', 'SonataUserBundle');
        $instance->addResource('xlf', 'C:/wamp/www/fenneck-site/app/Resources/translations\\ThraceMediaBundle.fr.xlf', 'fr', 'ThraceMediaBundle');
        return $instance;
    }

    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/fenneck-site/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/fenneck-site/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/fenneck-site/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/wamp/www/fenneck-site/app/cache/prod',
            ...
            'router.resource' => 'C:/wamp/www/fenneck-site/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/fenneck-site/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/fenneck-site/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/fenneck-site/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/fenneck-site/app/cache/prod/doctrine/orm/Proxies',
