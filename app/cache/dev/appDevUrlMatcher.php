            ...
            if (0 === strpos($pathinfo, '/back/gestion/core')) {
                ...
                if (0 === strpos($pathinfo, '/back/gestion/core/gallerie')) {
                    ...
                    if ($pathinfo === '/back/gestion/core/gallerie/list') {
                        return array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::listAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_list',  '_route' => 'admin_gestion_core_gallerie_list',);
                    }

                    // admin_gestion_core_gallerie_create
                    if ($pathinfo === '/back/gestion/core/gallerie/create') {
                        return array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::createAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_create',  '_route' => 'admin_gestion_core_gallerie_create',);
                    }

                    // admin_gestion_core_gallerie_batch
                    if ($pathinfo === '/back/gestion/core/gallerie/batch') {
                        return array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::batchAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_batch',  '_route' => 'admin_gestion_core_gallerie_batch',);
                    }

                    // admin_gestion_core_gallerie_edit
                    if (preg_match('#^/back/gestion/core/gallerie/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_gestion_core_gallerie_edit')), array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::editAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_edit',));
                    }

                    // admin_gestion_core_gallerie_delete
                    if (preg_match('#^/back/gestion/core/gallerie/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_gestion_core_gallerie_delete')), array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::deleteAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_delete',));
                    }

                    // admin_gestion_core_gallerie_show
                    if (preg_match('#^/back/gestion/core/gallerie/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_gestion_core_gallerie_show')), array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::showAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_show',));
                    }

                    // admin_gestion_core_gallerie_export
                    if ($pathinfo === '/back/gestion/core/gallerie/export') {
                        return array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::exportAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_export',  '_route' => 'admin_gestion_core_gallerie_export',);
                    }

                    // admin_gestion_core_gallerie_test
                    if (preg_match('#^/back/gestion/core/gallerie/(?P<id>[^/]++)/test$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_gestion_core_gallerie_test')), array (  '_controller' => 'Gestion\\CoreBundle\\Controller\\GallerieAdminController::testAction',  '_sonata_admin' => 'gestion_core.admin.gallerie',  '_sonata_name' => 'admin_gestion_core_gallerie_test',));
                    }
